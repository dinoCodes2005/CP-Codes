...
public class Exponentiation2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // }
        int t = in.i();
        Exponentiation2 obj = new Exponentiation2();
    ...
    public void solveTestCase() throws Exception {
        ...
        int c = in.i();
        int p = (int)1e9 + 7;
        int b_power_c = modPow(b,c,p-1);
        int a_power_b_power_c = modPow(a,b_power_c,p);
        out.pl(a_power_b_power_c);
    }
    ...
    public int modPow(int base,int exp,int mod){
        ...
        if((exp & 1) == 0){
            int even = modPow(base,exp>>1,mod);
            return (int)((even * 1l * even) % mod);
        }
        return (int)((base * 1l * modPow(base,exp-1,mod)) % mod);
    }
