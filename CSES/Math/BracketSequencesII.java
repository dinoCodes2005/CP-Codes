...
public class BracketSequencesII {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // }
        BracketSequencesII obj = new BracketSequencesII();
        obj.solveTestCase();
        out.flush();
        out.close();
    }
    ...
    public void solveTestCase() throws Exception {
        ...
        Let the number of unclosed open brackets in 'P' be k.
        and the number of new open brackets introduced in 'S' in n.
        So total length of S = n + n + k = 2n + k
        All possible bracket combinations in S = 2n+k C n
        Invalid combinations = 2n+k C n-1 [Derived from Bracket Sequences I]
        So valid combinations = (2n+k C n) - (2n+k C n-1)
                              = (2n+k C n)(k+1)/(n+k+1)
        ...
        */
        ...
        long res = nCr(2l*n+k, n, mod);
        res = (res * (k+1l)) % mod;
        long inv = modInverse(n+k+1l, mod);
        res = (res * inv) % mod;
