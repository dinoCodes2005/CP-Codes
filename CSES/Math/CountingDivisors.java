...
public class CountingDivisors {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // }
        int t = in.i();
        int div[] = new int[ub+1];
        for(int d=1;d<=ub;d++){
            for(int m=d;m <= ub;m+=d){
                div[m]++;
            }
        }
        CountingDivisors obj = new CountingDivisors();
        while(t-- > 0) obj.solveTestCase(div);
        out.flush();
        out.close();
    }

    public void solveTestCase(int div[]) throws Exception {
        // write code
        out.pl(div[in.i()]);
    }
