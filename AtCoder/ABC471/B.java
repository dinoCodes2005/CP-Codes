...
public class B {
    ...
    static class string {
        ...
        @Override
        public boolean equals(Object obj) {if (this == obj) return true;if (!(obj instanceof string)) return false;string other = (string) obj;return sb.toString().equals(other.toString());}
